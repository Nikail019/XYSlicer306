...
void parseErrorCommand() {
  // Used in the ERR state to check ONLY for the reset to idle (M999) command
  getCommand();
...
void PIDControl(float current_position, float target_position, uint16_t* integral, uint16_t* previous_error) {
